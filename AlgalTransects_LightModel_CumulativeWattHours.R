## This script will add a new column in the Algal Transects data frame that includes the cumulative watt hours of sunlight that have hit a given point from April 15 to the summer solstice (yearday = 172) for each point in all the transects
